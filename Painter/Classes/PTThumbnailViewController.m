//
//  PTThumbnailViewController.m
//

#import "PTThumbnailViewController.h"


@implementation PTThumbnailViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section 
{
  ...
  CGFloat numberOfPlaceholders = [PTScribbleThumbnailCell numberOfPlaceHolders];
  NSInteger numberOfScribbles = [scribbleManager_ numberOfScribbles];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
  ...
  PTScribbleThumbnailCell *cell = (PTScribbleThumbnailCell *)[tableView 
                                                          dequeueReusableCellWithIdentifier:CellIdentifier];
  if (cell == nil) 
  {
    cell = [[PTScribbleThumbnailCell alloc] initWithStyle:UITableViewCellStyleDefault
  ...
  // cell can support
  NSInteger numberOfSupportedThumbnails = [PTScribbleThumbnailCell numberOfPlaceHolders];
