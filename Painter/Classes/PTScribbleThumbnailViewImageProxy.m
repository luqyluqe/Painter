...
@implementation PTScribbleThumbnailViewImageProxy
...
- (PTScribble *) scribble
{
  if (scribble_ == nil)
  {
    ...
    scribble_ = [PTScribble scribbleWithMemento:scribbleMemento];
  }
